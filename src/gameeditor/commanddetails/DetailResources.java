...
public enum DetailResources {
		...
		//PROPERTIES_COMBO(new String [] { "Damage", "Points", "Time", "Health","Gravity","Speed"}),
		//PROPERTIES_TEXT_INPUT (new String[]{"Destrictible","Random","Movable"}),
		...
		RANDOM(new String [] {"0", "1"}),
		MOVABLE(new String [] {"0", "1"}),
