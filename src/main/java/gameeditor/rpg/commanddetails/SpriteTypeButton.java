...
public class SpriteTypeButton {
    ...
    public SpriteTypeButton(double width, double height, String filePath, String type, IGridDesignArea da, IGameEditorData dataStore, IDetailPane idp) {
        myDetailPane = idp;
        myFilePath = filePath;
    ...
    private void handleRelease(){
    	if (!dragExited){
    		...
    		myDesignArea.removeDragIn(myTempImageView);
	        GameObjectView go = new GameObjectView(myFilePath, myX, myY, myType, false, myDesignArea.getHoverCell(), myDesignArea, myDataStore);
