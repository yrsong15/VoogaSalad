...
public class GameObject {
	...
	public GameObject(String imageFilePath, String type, IDesignArea da, IGameEditorData dataStore) {
		this(imageFilePath, DEFAULT_X, DEFAULT_Y, type, da, dataStore);
	}
	
	public GameObject(String imageFilePath, double x, double y, String type, IDesignArea da, IGameEditorData dataStore) {
		this(imageFilePath, x, y, DEFAULT_WIDTH, DEFAULT_HEIGHT, type, da, dataStore);
	}
	
	public GameObject(String imageFilePath, double x, double y, double fitWidth, double fitHeight, String type, IDesignArea da, IGameEditorData dataStore) {
